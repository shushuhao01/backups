...
This will fail in production.`);
  ...
  const _imports_0$1 = "/assets/logo.46719607.png";
  ...
  const PagesSplashIndex = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-cf5f955c"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/splash/index.vue"]]);
  ...
  const PagesServerConfigIndex = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-dacb39f7"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/server-config/index.vue"]]);
    ...
    setup(__props, { expose: __expose }) {
      ...
      const handleLogin = async () => {
        ...
        try {
          ...
          formatAppLog("log", "at pages/login/index.vue:125", "登录成功，token已保存:", userStore.token ? "有" : "无");
          ...
          setTimeout(() => {
            formatAppLog("log", "at pages/login/index.vue:140", "跳转首页，当前token:", userStore.token ? "有" : "无");
            uni.switchTab({ url: "/pages/index/index" });
          }, 1200);
        } catch (e) {
          uni.showToast({
      ...
      const __returned__ = { serverStore, userStore, username, password, rememberPassword, isLoading, canLogin, handleLogin, goToServerConfig };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  });
        ...
        vue.createElementVNode("view", { class: "options" }, [
          vue.createElementVNode("view", {
            ...
            vue.createElementVNode(
              ...
              [
                $setup.rememberPassword ? (vue.openBlock(), vue.createElementBlock("text", { key: 0 }, "✓")) : vue.createCommentVNode("v-if", true)
              ],
              2
              /* CLASS */
            ),
  ...
  const PagesLoginIndex = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-45258083"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/login/index.vue"]]);
  ...
  class RecordingService {
    ...
    async uploadRecordingFile(callId, recording) {
      ...
      try {
        ...
        formatAppLog("error", "at services/recordingService.ts:340", "[RecordingService] 录音上传失败:", e);
        return false;
      }
    }
    /**
    ...
    async processCallRecording(callInfo) {
      formatAppLog("log", "at services/recordingService.ts:353", "[RecordingService] 处理通话录音:", callInfo.callId);
      const hasPermission = await this.checkPermissions();
      if (!hasPermission) {
        formatAppLog("warn", "at services/recordingService.ts:358", "[RecordingService] 没有存储权限");
    ...
    async tryEnableSystemRecording() {
      try {
        const brand = this.getDeviceBrand();
        formatAppLog("log", "at services/recordingService.ts:388", "[RecordingService] 尝试开启系统录音, 品牌:", brand);
        if (brand.includes("xiaomi") || brand.includes("redmi")) {
        ...
        formatAppLog("error", "at services/recordingService.ts:413", "[RecordingService] 开启系统录音失败:", e);
      }
      return false;
    }
    /**
    ...
    enableXiaomiRecording() {
      ...
      for (let i = 0; i < attempts.length; i++) {
        try {
          attempts[i]();
          formatAppLog("log", "at services/recordingService.ts:472", `[RecordingService] 小米录音设置打开成功，方式${i + 1}`);
          return true;
        } catch (_e) {
          formatAppLog("log", "at services/recordingService.ts:475", `[RecordingService] 小米录音设置方式${i + 1}失败，尝试下一种`);
        }
      }
      return false;
    }
    ...
    enableHuaweiRecording() {
      ...
      for (let i = 0; i < attempts.length; i++) {
        try {
          attempts[i]();
          formatAppLog("log", "at services/recordingService.ts:520", `[RecordingService] 华为录音设置打开成功，方式${i + 1}`);
          return true;
        } catch (_e) {
          formatAppLog("log", "at services/recordingService.ts:523", `[RecordingService] 华为录音设置方式${i + 1}失败，尝试下一种`);
        }
      }
      return false;
    }
    ...
    enableOppoRecording() {
      ...
      for (let i = 0; i < attempts.length; i++) {
        try {
          attempts[i]();
          formatAppLog("log", "at services/recordingService.ts:570", `[RecordingService] OPPO录音设置打开成功，方式${i + 1}`);
          return true;
        } catch (_e) {
          formatAppLog("log", "at services/recordingService.ts:573", `[RecordingService] OPPO录音设置方式${i + 1}失败，尝试下一种`);
        }
      }
      return false;
    }
    ...
    enableVivoRecording() {
      ...
      for (let i = 0; i < attempts.length; i++) {
        try {
          attempts[i]();
          formatAppLog("log", "at services/recordingService.ts:618", `[RecordingService] VIVO录音设置打开成功，方式${i + 1}`);
          return true;
        } catch (_e) {
          formatAppLog("log", "at services/recordingService.ts:621", `[RecordingService] VIVO录音设置方式${i + 1}失败，尝试下一种`);
        }
      }
      return false;
    }
    ...
    enableGenericRecording() {
      ...
      for (let i = 0; i < attempts.length; i++) {
        try {
          attempts[i]();
          formatAppLog("log", "at services/recordingService.ts:660", `[RecordingService] 通用录音设置打开成功，方式${i + 1}`);
          return true;
        } catch (_e) {
          formatAppLog("log", "at services/recordingService.ts:663", `[RecordingService] 通用录音设置方式${i + 1}失败，尝试下一种`);
        }
      }
      return false;
    }
      ...
      try {
        ...
        for (const basePath of paths) {
          try {
            ...
            if (dir.exists() && dir.isDirectory()) {
              folderExists = true;
              formatAppLog("log", "at services/recordingService.ts:690", "[RecordingService] 找到录音文件夹:", basePath);
              break;
            }
          } catch (_e) {
          }
        ...
        if (!folderExists) {
          formatAppLog("log", "at services/recordingService.ts:699", "[RecordingService] 未找到任何录音文件夹");
          return false;
        }
        const recordings = await this.scanRecordingFolders();
        formatAppLog("log", "at services/recordingService.ts:705", "[RecordingService] 扫描到录音文件数量:", recordings.length);
        if (recordings.length === 0) {
          formatAppLog("log", "at services/recordingService.ts:710", "[RecordingService] 录音文件夹存在但无录音文件，可能已开启");
          return true;
        }
        const sevenDaysAgo = Date.now() - 7 * 24 * 60 * 60 * 1e3;
        const recentRecordings = recordings.filter((r) => r.lastModified > sevenDaysAgo);
        if (recentRecordings.length > 0) {
          formatAppLog("log", "at services/recordingService.ts:719", "[RecordingService] 有最近7天的录音文件:", recentRecordings.length);
          return true;
        }
        formatAppLog("log", "at services/recordingService.ts:724", "[RecordingService] 有录音文件但都是7天前的");
        return true;
      } catch (e) {
        formatAppLog("error", "at services/recordingService.ts:727", "[RecordingService] 检查录音状态失败:", e);
        return false;
      }
    }
    /**
    ...
    async cleanupExpiredRecordings(retentionDays = 3) {
      ...
      try {
        ...
        const File = plus.android.importClass("java.io.File");
        formatAppLog("log", "at services/recordingService.ts:761", `[RecordingService] 开始清理 ${retentionDays} 天前的录音文件`);
        formatAppLog("log", "at services/recordingService.ts:762", `[RecordingService] 截止时间: ${new Date(cutoffTime).toLocaleString()}`);
        formatAppLog("log", "at services/recordingService.ts:763", `[RecordingService] 扫描到录音文件: ${recordings.length} 个`);
        for (const recording of recordings) {
          ...
          try {
            ...
            if (file.exists() && file.delete()) {
              ...
              formatAppLog("log", "at services/recordingService.ts:781", `[RecordingService] 已删除: ${recording.name}`);
            } else {
        ...
        formatAppLog("log", "at services/recordingService.ts:790", `[RecordingService] 清理完成: 删除 ${result.deletedCount} 个文件，释放 ${(result.freedSpace / 1024 / 1024).toFixed(2)} MB`);
      } catch (e) {
        formatAppLog("error", "at services/recordingService.ts:792", "[RecordingService] 清理录音失败:", e);
    ...
    async getRecordingStats() {
      ...
      try {
        ...
        formatAppLog("error", "at services/recordingService.ts:833", "[RecordingService] 获取录音统计失败:", e);
      }
      return stats;
    }
  }
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-83a5a03c"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/index/index.vue"]]);
  ...
  const PagesCallsIndex = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-171cc5c2"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/calls/index.vue"]]);
  ...
  const PagesStatsIndex = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-774cec60"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/stats/index.vue"]]);
...
释放空间: ${freedMB} MB`,
          ...
          success: async (res) => {
            ...
            if (res.confirm) {
              ...
              try {
                ...
                uni.hideLoading();
                formatAppLog("error", "at pages/settings/index.vue:805", "解绑失败:", e);
                userStore.clearDeviceInfo();
  ...
  const PagesSettingsIndex = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-b4180827"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/settings/index.vue"]]);
  ...
  const PagesScanIndex = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-99526857"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/scan/index.vue"]]);
  ...
  const PagesCallingIndex = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-2f1addb2"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/calling/index.vue"]]);
  ...
  const PagesCallEndedIndex = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-acbf5c2b"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/call-ended/index.vue"]]);
  ...
  const PagesCallDetailIndex = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-7dde404a"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/call-detail/index.vue"]]);
  ...
  const PagesDialpadIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-1f062f68"], ["__file", "D:/kaifa/CRM - 1.8.0开发中/crmAPP/src/pages/dialpad/index.vue"]]);
